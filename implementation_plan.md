...
| P3-04 | 공급자·세션·지연, H1 압력, ADR fair/premium, 전략 신호·비용·차단, 포지션·두 다리·PnL·킬스위치의 Streamlit 운영 대시보드 구축 | P3-01~P3-03 | PRD 15.1 항목을 동일 run ID와 시점으로 조회, 대시보드 중단이 수집·페이퍼 실행에 무영향 | FR-02, FR-05, FR-07, FR-13~FR-16 |
